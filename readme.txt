...
In github zuerst auf "Code" drücken und dann auf download zip. Die Dateien werden als gepacktes File auf deinen Computer heruntergeladen. Jetzt einfach der Anleitung folgen.

0. Zip File entpacken 
1. Gehe in das Verzeichnis "01 - INSTALL_FIRST". Installiere zuerst den Fabric Loader (01 - fabric-installer-0.10.2.exe) für die Minecraft Version 1.18.
2. Starte Minecraft, um zu testen ob der FABRIC Loader startet, dann Client wieder schließen.
...
7. Jetzt die Verzeichnisse mods und shaderpacks vom Ordner "02-COPY_INTO_MINECRAFT_FOLDER" in das .minecraft Verzeichnis kopieren.
...
12. Im Iris Installer:
		a. Version 1.18 wählen und für Fabric-Mode anticken
		b. Installieren
	Nach der Installation Minecraft Client starten.
...
P.S. Wenn Du das erste Mal auf den Server kommst, musst du Noah kontaktieren, dass er deine Zugriffsrechte einschaltet.
	Auf dem Server ist WorldEdit installiert. Um es nutzen zu können musst Du im Creativ Modus sein.
